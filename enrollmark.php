...
<TR>
<TD>
<input type="button" style="height:50px;width:200px" value="add course" onclick="window.location ='upldatemark.php'">
</TD>
<TD>
<input type="button" style="height:50px;width:200px" value="enter mark detais" onclick="window.location ='mark.php'">
</TD>
</TR>
</table
</head>
