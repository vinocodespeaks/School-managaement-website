...
<body>
  <div class="login">
  <h1><strong><font color ='aqua'>Admin Page</font></strong><br><br><i>Sign in</i></h1>
    <form method="post"action="default1.php">
        ...
        <button type="submit"  name ="loger"class="btn btn-primary btn-block btn-large">Let me in.</button>
